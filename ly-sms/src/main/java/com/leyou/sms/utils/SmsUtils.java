...
public class SmsUtils {
    ...
    public SendSmsResponse sendSms(String phonenum, String signName, String templateCode, String templateParam) {
        ...
        try {
            ...
            if (!"OK".equals(sendSmsResponse.getCode())) {
                log.info("【短信服务】短信发送失败，phoneNumber:{},发送内容:{},原因:{}", phonenum, templateParam, sendSmsResponse.getMessage());
            }
            stringRedisTemplate.opsForValue().set(key, String.valueOf(System.currentTimeMillis()), 1, TimeUnit.MINUTES);
            return sendSmsResponse;
        } catch (ClientException e) {
            log.error("【短信服务】发送短信异常,手机号码:{}", phonenum, e);
            return null;
        }
    }
}
